...
---
# Making tables with ***FormatTable*** 
...
.Renviron
```
This will prevent you from accidentally pushing your AIMS API Key onto GitHub. Your AIMS API Key is meant just for you, not put it on GitHub 


To check that your AIMS API Key is stored correctly run 
